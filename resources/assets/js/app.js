        ...
        if (!('error' in data['achievements']))
        {
            raid8Data  = displayCardWithTurnsByClears('The Binding Coil of Bahamut',
                         ...
                         displayCardWithTurnsByClears('The Final Coil of Bahamut',
                            ...
                            't13.jpg') +
                            displayCardWithTurnsByClears('Alexander',
                                new Array(
                                ...
                                'a4.jpg') +
                            displayCardWithTurnsByClears('Alexander (Savage)',
                               new Array(
                               ...
                               new Array(
                                   displayEmptyRow('Fist of the Father'),
                                   displayEmptyRow('Cuff of the Father'),
                                   displayEmptyRow('Arm of the Father'),
                                   displayEmptyRow('Burden of the Father')
                               ),
                               'a4.jpg');
